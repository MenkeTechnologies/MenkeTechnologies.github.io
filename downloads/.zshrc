...
plugins=(fzf-zsh zsh-completions zsh-syntax-highlighting zsh-autosuggestions tmux sublime ruby gem rake rails yarn ng coffee node npm perl osx pod debian brews cpanm git github gradle scala spring django pip python man nmap postgres colorize sudo z r)
